...
EMAIL_HOST_PASSWORD = 'uzug zmaj qtgc dkmv'  # Your Gmail password or app password (if you have 2-step verification)
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
EMAIL_USE_LOCALTIME = True


# Optional: Email sending timeout
EMAIL_TIMEOUT = 1  # Timeout in seconds (optional)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'app.context_processors.banner_images',
            ],
        },
    },
]
